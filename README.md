...
This project uses real-time ISS trajectory data to build a containerized Flask app for users to interact with. Overall, the project aims to process the ISS trajectory data and allow users to easily retrieve the processed data suing the API endpoints.
